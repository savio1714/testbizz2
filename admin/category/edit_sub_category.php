...
$id = $_GET['vkvbvjfgfikix'];
    ...
    $stmt = $conn->prepare("SELECT * FROM subcategory where status='1' and id='".$id."'");
    $stmt->execute();
    ...
    if($stmt->rowCount()>0){
        foreach (($stmt->fetchAll()) as $key => $row) {
            ...
            $stmt2 = $conn->prepare("SELECT * FROM category where status='1' and id='".$category_id."'");
            $stmt2->execute();
             // set the resulting array to associative
                                ...
                                <div class="tab-inn">
                                    <form>
                                        ...
                                        <div class="form-group col-md-12 col-sm-12">
                                                <label>Name</label>
                                                <input type="text"  id="name" placeholder="Name" <?php echo 'value="'.$sub_category_name.'"';?>>
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                               ...
                                               $stmt = $conn->prepare("SELECT * FROM category WHERE status = 1 ORDER BY category_name ASC");
                                                ...
                                                <option value="<?php echo $category_id;?>"><?php echo $category_name.' (Already Selected)' ; ?></option>
                                                <?php 
                                                if($stmt->rowCount()>0){
                                                     foreach (($stmt->fetchAll()) as $key => $row) {  
                                         ...
                                         <div class="input-field col-md-col-md-12 col-sm-12">
                                                <input id="description" type="text"  <?php echo 'value="'.$description.'"';?> >
                                              ...
                                              <label style="margin-top: -34px;font-size: 0.8rem;">Picture</label>
                                                    <div class="file-field input-field">
                                                     ...
                                                     <div >
                                                        <?php
                                                        if($picture ==''){
                                                            echo '<img src="../../uploading/not_uploaded.png" alt="picture" class="imgsize" id="img">';
                                                        }else{
                                                            echo '<img alt="picture" class="imgsize" id="img" src="../../uploading/'.$picture.'">
                                                    ';
                                                        }
                                                     ?>
...
<div >
                                            ...
                                            <input type="hidden" id="subcatid" name="subcatid" <?php echo  'value="'.$id.'"';?>>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="#" id="editSubCategory" class="waves-effect waves-light btn-large">SAVE</a> 
