            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        </li><li class="active-bre"><a href="franchisee">Franchisee </a>
                        </li>
                        <li class="active-bre"><a href="#"> Add Franchisee </a>
                        </li>
                        <li class="page-back"><a href="franchisee"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <label for="sales_manager_id" style="margin-top: -6%;font-size: 0.8rem;">Floor Manager Id</label>
                                                ...
                                                <select id="sales_manager_id"  class="selectdesign">
                                                    <option value="">-- Select Floor Manager Id --</option>
                                                    <?php 
                                                    if($stmt->rowCount()>0){
                                                        ...
                                                        echo '<option value="">Floor Manager not available</option>'; 
                                                    } 
                                                    ?>
                                                </select>
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <input type="text"  id="sales_manager_name" placeholder="No Floor Manager Name" readonly>
