                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                <!-- <input id="franchisee_id" type="text"> -->
                                                <label for="franchisee_id" style="margin-top: -6%;font-size: 0.8rem;">Franchisee Id</label>

                                                <?php
                                                require '../connect.php';
                                                $stmt = $conn->prepare("SELECT * FROM franchisee WHERE status = 1 ORDER BY franchisee_id ASC");
                                                $stmt->execute();

                                                                                                   
                                                $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                                ?>
                                                <select id="franchisee_id"  class="selectdesign">
                                                    <option value="">-- Select Franchisee Id --</option>
                                                    <?php 
                                                    if($stmt->rowCount()>0){
                                                        ...
                                                        echo '<option value="">franchisee not available</option>'; 
                                                    } 
                                                    ?>
                                                </select>
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <input type="text"  id="franchisee_name" placeholder="No Franchisee Name" readonly>
                                                
                                            </div>
                                            <!-- <div class="input-field col-md-6 col-sm-12">
                                                <input id="franchisee_name" type="text" readonly>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer.php" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="#" class="waves-effect waves-light btn-large" id="addTravelAgent">Submit</a>
