                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                       ...
                       <!--  <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-user" aria-hidden="true"></i> Category</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a class="<?php echo (basename($_SERVER['PHP_SELF'])=='add_new_category.php')? 'menu-active':''?>" href="category/add_new_category.php">Add New Category</a>
                                    </li><li><a class="<?php echo (basename($_SERVER['PHP_SELF'])=='add_new_subcategory.php')? 'menu-active':''?>" href="category/add_new_subcategory.php">Add New Sub Category</a>
                                    </li>
                                    <li><a class="<?php echo (basename($_SERVER['PHP_SELF'])=='manage_categories.php')? 'menu-active':''?>" href="category/manage_categories">All Category</a>
                                    </li>
