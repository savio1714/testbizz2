            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Add Regional Manager </a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Add New Regional Manager</h4>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer.php" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="#" class="waves-effect waves-light btn-large" id="addReginalManager">Submit</a>
