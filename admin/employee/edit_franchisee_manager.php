...
if($editfor == 'pending'){
    ...
    $stmt = $conn->prepare("SELECT *,  (select zone_name from zone where id = '".$zone."') as zone_name, (select region_name from region where id = '".$region."') as region_name,(select branch_name from branch where id = '".$branch."') as branch_name, (select CONCAT(firstname,' ',lastname) from regional_manager where regional_manager_id = '".$reference_no."') as fname, (select state_name from states where id = '".$state."') as statename, (select city_name from cities where id = '".$city."') as city_name,(select country_name from countries where id = '".$country."') as countryname FROM `branch_manager` where $identifier_name'".$id."'");
    $stmt->execute();
    ...
    foreach (($stmt->fetchAll()) as $key => $row) {
        // $fid=$row['id'];
        $regional_manager_name=$row['fname'];

        $branch_manager_id=$row['branch_manager_id'];
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Edit Franchisee Manager </a>
                        </li>
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="input-field col-md-6 col-sm-12">
                                                <input id="regional_manager_id" type="text" value="<?php echo $reference_no ;?>" readonly>
                                            ...
                                            <div class="input-field col-md-6 col-sm-12">
                                                ...
                                                <input type="text" id="regional_manager_name" value="<?php echo $regional_manager_name ;?>" readonly>
                                                ...
                                                if($branch_manager_id !==''){
                                                   ...
                                                   <div class="row">
                                                    ...
                                                    <div class="input-field col-md-12 col-sm-12">
                                                        <input id="bmid" type="text" value="'.$branch_manager_id.'" readonly>
                                                        
                                                        <label for="bmid">Employee No.</label>
                                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                     ...
                                     <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="rm_id" name="rm_id" value="<?php echo $reference_no;?>">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer.php" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="#" class="waves-effect waves-light btn-large" id="editBranchManager">Edit</a>
