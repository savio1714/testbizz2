            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#">Floor Manager</a>
                        </li>
                            ...
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <ul id="dr-users" class="dropdown-content">
                                        <li><a href="add_floor_manager">Add Floor Manager</a>
                                        </li>
                                        <li><a href="flm/download_list?vkvbvjfgfikix=Pending">Download List</a>
                                       </li>
                                        ...
                                        <table class="table table-hover" id="pendingTable">
                                            ...
                                            <tbody>
                                                ...
                                                $srno++;
                                                        ...
                                                        echo '<tr>
                                                    <td colspan="8">No Pending Floor Manager
                                                    </td>
                                                    <tr>';
                                                    }
              ?>  
                            ...
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <ul id="dr-register-list" class="dropdown-content">
                                        <li><a href="sm/download_list?vkvbvjfgfikix=Registered">Download List</a>
                                        </li>
                                            ...
                                            <tbody>
                                               ...
                                               echo ' </tr>';
                                                ...
                                                $srno++;
                                                        ...
                                                        echo '<tr>
                                                    <td colspan="8">Not Registered Floor Manager
                                                    </td>
                                                    <tr>';
                                                    }
                                                ?> 
...
<script type="text/javascript">
    ...
    { 
        window.location.href='edit_floor_manager?vkvbvjfgfikix='+id+'&nohbref='+refno+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor+'&zdfds='+z+'&rdsfdsf='+r+'&bdfdsf='+b;  
    };
