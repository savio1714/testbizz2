...
<script type="text/javascript">
    ...
    function editfunc(id,cut,st,ct,editfor,z,r,b)
    { 
        window.location.href='edit_regional_manager?vkvbvjfgfikix='+id+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor+'&zdfds='+z+'&rdsfdsf='+r+'&bdfdsf='+b;  
    };
