            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Add Floor Manager </a>
                        </li>
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <label for="branch_manager_id" style="margin-top: -6%;font-size: 0.8rem;">Franchisee Manager Id</label>

                                                <?php
                                                require '../connect.php';
                                                $stmt = $conn->prepare("SELECT * FROM branch_manager WHERE status = 1 ORDER BY branch_manager_id ASC");
                                                $stmt->execute();
                                                ...
                                                <select id="branch_manager_id"  class="selectdesign">
                                                    <option value="">-- Select Franchisee Manager Id --</option>
                                                    <?php 
                                                    if($stmt->rowCount()>0){
                                                        ...
                                                        echo '<option value="">Franchisee Manager not available</option>'; 
                                                    } 
                                                    ?>
                                                </select>
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <input type="text"  id="branch_manager_name" placeholder="No Franchisee Manager Name" readonly>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer.php" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="#" class="waves-effect waves-light btn-large" id="addSalesManager">Submit</a>
    ...
    $('#country').on('change', function(){
        ...
        $('#branch_manager_id').on('change', function(){
            ...
            if(bm_id){
                 $.ajax({
                          type:'POST',
                          url:'../agents/branch_manager_name',
