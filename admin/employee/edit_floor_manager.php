...
if($editfor == 'pending'){
    ...
    $stmt = $conn->prepare("SELECT *, (select zone_name from zone where id = '".$zone."') as zone_name, (select region_name from region where id = '".$region."') as region_name,(select branch_name from branch where id = '".$branch."') as branch_name,(select CONCAT(firstname,' ',lastname) from branch_manager where branch_manager_id = '".$reference_no."') as fname, (select city_name from cities where id = '".$city."'), (select state_name from states where id = '".$state."') as statename, (select city_name from cities where id = '".$city."') as city_name,(select country_name from countries where id = '".$country."') as countryname FROM `sales_manager` where $identifier_name'".$id."'");
    $stmt->execute();
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        </li><li class="active-bre"><a href="floor_manager">Floor Manager </a>
                        </li>
                        <li class="active-bre"><a href="#"> Edit Floor Manager </a>
                        </li>
                        <li class="page-back"><a href="floor_manager"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="input-field col-md-6 col-sm-12">
                                                <input id="branch_manager_id" type="text" value="<?php echo $reference_no ;?>" readonly>
                                                <label>Franchisee Manager Id</label>

                                            </div>

                                            <div class="input-field col-md-6 col-sm-12">
                                                <label>Franchisee Manager Name</label>
                                                <input type="text" id="branch_manager_name" value="<?php echo $branch_manager_name ;?>" readonly>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer.php" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="#" class="waves-effect waves-light btn-large" id="editSalesManager">Edit</a>
