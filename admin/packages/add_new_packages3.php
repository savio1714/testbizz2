            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="page-back"><a href="add_new_packages2.php"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Add New Package - Itinerary Details</h4>
                                ...
                                <div class="tab-inn">
                                    <form>
                                        ...
                                        <label for="w3review">Inclusion</label>

                                         <textarea id="inclusion" name="iinclusion" rows="5" cols="50">
                                    ...
                                    <div class="row">
                                        ...
                                        <label for="w3review">Exclusion</label>

                                         <textarea id="exclusion" name="exclusion" rows="5" cols="50">
                                         
                                         </textarea> 
                            
                                        </div><div class="row">
                                            
                                        <label for="w3review">Remark</label>

                                         <textarea id="remark" name="remark" rows="5" cols="50">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer.php" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="add_new_packages4.php" class="waves-effect waves-light btn-large" >Next</a>
