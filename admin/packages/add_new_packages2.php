            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="page-back"><a href="add_new_packages.php"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Add New Package - Package Extra Information</h4>
                                       ...
                                       <div class="input-field col-md-12 col-sm-12">
                                           ...
                                           <div class="input-field col-md-12 col-sm-12">
                                            ...
                                            <div class="input-field col-md-12 col-sm-12">
                                                ...
                                                <input type="text"  id="night"  >
                                                
                                            </div>
                                        <div class="input-field col-md-12 col-sm-12">
                                                <label>Sightseeing Type</label>
                                                <input type="text"  id="sightseeing"  >
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer.php" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="add_new_packages3.php" class="waves-effect waves-light btn-large">Next</a>
