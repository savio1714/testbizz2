            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        </li><li class="active-bre"><a href="all_packages.php">Packages </a>
                        </li>
                        <li class="active-bre"><a href="#"> Edit Package  </a>
                        </li>
                        <li class="page-back"><a href="all_packages.php"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Edit Package - General Information</h4>
                                     ...
                                     <div class="form-group col-md-6 col-sm-12">
                                       ...
                                       <div class="form-group col-md-12 col-sm-12">
                                           ...
                                           <div class="form-group col-md-12 col-sm-12">
                                                ...
                                                <input type="text"  id="package_name" placeholder="unique code" >
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" style="margin-top: 20px;">
                                               <!--  <a href="registered_customer.php" class="waves-effect waves-light btn-large">Back</a> -->
                                                 ...
                                                 <a href="edit_new_packages2.php" class="waves-effect waves-light btn-large" >Next</a>
