                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input id="first_name" type="text" value="CUS1465352" readonly>
                                                <label for="first_name">Customer ID</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="last_name" type="text" Value="9876543210" readonly>
                                                <label for="last_name">Phone No.</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="phone" type="text" value="07/07/2018"  readonly>
                                                <label for="phone">Email ID</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="email" type="email" value="123456789" readonly>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="gender" type="text" value="Goa tour" readonly>
                                                <label for="phone">Package Name</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="bdate" type="email" value="20,000/-" readonly>
                                         ...
                                         <div class="row">
                                          ...
                                          <!--   <div class="input-field col s6">
                                            ...
                                            <div class="input-field col s6">
                                                <input id="name" type="text" value="Net Banking" readonly>
