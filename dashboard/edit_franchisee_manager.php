...
$rm_firstname =$_SESSION["username2"];
$rm_lastname =$_SESSION["lname"];
...
require '../connect.php';
    ...
    $stmt = $conn->prepare("SELECT *,(select zone_name from zone where id = '".$zone."') as zone_name, (select region_name from region where id = '".$region."') as region_name,(select branch_name from branch where id = '".$branch."') as branch_name, (select city_name from cities where id = '".$city."'), (select state_name from states where id = '".$state."') as statename, (select city_name from cities where id = '".$city."') as city_name,(select country_name from countries where id = '".$country."') as countryname FROM `branch_manager` where branch_manager_id ='".$id."'");
    $stmt->execute();
...
<head>
    ...
    <title>Edit Franchisee Manager | Bizzmirth Holidays</title>
    <!-- Favicon -->
...
<body>
    ...
    <div id="container-wrapper">
        ...
        <div id="dashboard">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 padding-right-30">
                        <div class="dashboard-list-box">
                            <h4 class="gray">Edit Franchisee Manager Details</h4>
                            <div class="dashboard-list-box-static">
                                ...
                                <div class="row">
                                        ...
                                        <label>Regional Manager ID</label>
                                        <input id="rm_id" type="text" placeholder="Regional Manager ID" value="<?php echo $user_id?>" readonly>
                                   ...
                                   <div class="col-lg-6 col-md-6">
                                        ...
                                        <input id="rm_name"  type="text" placeholder="Regional Manager Name" value="<?php echo $rm_firstname . ' '. $rm_lastname;?>" readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <label>Franchisee Manager First Name</label>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <label>Franchisee Manager Last Name</label>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <label class="margin-top-0">Zone</label>
                                        ...
                                        <select id="zone_name" class="chosen-select-no-single" >
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <label>Region</label>
                                        <select id="region_name" class="chosen-select-no-single" >
                                             <?php
                                                        require '../connect.php';
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <label>Branch</label>
                                            <select id="branch_name" class="chosen-select-no-single" >
                                                <?php
                                                        require '../connect.php';
                                            ...
                                            <div id="branchMessage" style="display:none;color: #e74c3c;font-size: 85%;"></div>
                                        </div>
                            ...
                            <button id="edit_branch_manager" class="button" >Save Changes</button>
            ...
            <input id="bm_id" type="hidden" value="<?php echo $id ;?>"  disabled>
