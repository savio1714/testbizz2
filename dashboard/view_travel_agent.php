...
<head>
    ...
    <title>View Travel Agent List | Bizzmirth Holidays</title>
    <!-- Favicon -->
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="dashboard-list-box">
                            <h4 class="gray">View Travel Agent</h4>
                            <div class="table-box">
                               ...
                               <thead>
                                ...
                                <tbody>
                                     ...
                                     <?php
                                                ...
                                                $srno =1;
                                                $stmt = $conn->prepare("SELECT * FROM travel_agent where user_type='3' and reference_no='".$user_id."' and status='1' order by travel_agent_id LIMIT $start_from, $per_page_record");
                                                $stmt->execute();
                                                ...
                                                if($stmt->rowCount()>0){
                                                    foreach (($stmt->fetchAll()) as $key => $row) {
                                                        ...
                                                        echo ' <tr>
                                                    <th scope="row"> '.$row['travel_agent_id'].'
                                                    </th>
                                                    ...
                                                    <td>'.$datev.'</td>
                                                    <td>
                                                      <button type="button" onclick=\'editfunc("' .$row["travel_agent_id"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '")\' class="btn btn-primary">Edit</button>
                                                      
                                                    <button type="button"  onclick=\'deletefunc("' .$row["travel_agent_id"]. '","'.$user_id.'")\' class="btn btn-danger">Delete</button>
                                                    </td>
                                                ...
                                                $srno++;
                                                        ...
                                                        echo '<tr>
                                                    <td colspan="7">No Travel Agent Register By You
                                                    </td>
                                                    <tr>';
                                                    }
              ?>
                            ...
                            <nav class="pagination">
                                <ul>
                                     <?php 
                                      ...
                                      $sql2= $conn->prepare("SELECT COUNT(*) as c FROM travel_agent where user_type='3' and reference_no='".$user_id."' and status='1'");
                                        $sql2->execute();
    ...
    function deletefunc(travel_agent_id,f_id)
    { 
    var dataString = 'travel_agent_id='+ travel_agent_id+'&f_id='+f_id;
