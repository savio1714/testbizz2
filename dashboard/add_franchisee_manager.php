...
<head>
    ...
    <title>Add Franchisee Manager | Bizzmirth Holidays</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 padding-right-30">
                        <div class="dashboard-list-box">
                            <h4 class="gray">Franchisee Manager Details</h4>
                            <div class="dashboard-list-box-static">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-lg-6 col-md-6">
                                        ...
                                        <input id="rm_name"  type="text" placeholder="Regional Manager Name" value="<?php echo $firstname . ' '. $lastname;?>" readonly>
                            ...
                            <button id="registerBranchManager" class="button" >Register</button>
