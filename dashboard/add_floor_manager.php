...
<head>
    ...
    <title>Add Floor Manager | Bizzmirth Holidays</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 padding-right-30">
                        <div class="dashboard-list-box">
                            <h4 class="gray">Floor Manager Details</h4>
                            <div class="dashboard-list-box-static">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-lg-6 col-md-6">
                                        ...
                                        <input id="bm_name"  type="text" placeholder="Franchisee Manager Name" value="<?php echo $firstname . ' '. $lastname;?>" readonly>
