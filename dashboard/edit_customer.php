...
$ta_firstname =$_SESSION["username2"];
$ta_lastname =$_SESSION["lname"];
...
require '../connect.php';
    ...
    $stmt = $conn->prepare("SELECT *, (select city_name from cities where id = '".$city."'), (select state_name from states where id = '".$state."') as statename, (select city_name from cities where id = '".$city."') as city_name,(select country_name from countries where id = '".$country."') as countryname FROM `customer` where cust_id ='".$id."'");
    $stmt->execute();
...
<head>
    ...
    <title>Edit Customer | Bizzmirth Holidays</title>
    <!-- Favicon -->
...
<body>
    ...
    <div id="container-wrapper">
        ...
        <div id="dashboard">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 padding-right-30">
                        <div class="dashboard-list-box">
                            <h4 class="gray">Edit Customer Details</h4>
                            <div class="dashboard-list-box-static">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-lg-6 col-md-6">
                                        ...
                                        <input id="ta_name"  type="text" placeholder="Travel Agent Name" value="<?php echo $ta_firstname . ' '. $ta_lastname;?>" readonly>
                                ...
                                <div class="row">
                                        ...
                                        <?php if($customer_reference_no ==''){
                                        echo '<input id="customer_level"  type="text" placeholder="Customer Reference No." value="No Reference Number "  readonly>';
                                        }else{
                                            echo '<input id="customer_level"  type="text" placeholder="Customer Reference No." value="'.$customer_reference_no.' "  readonly>';
                                        }
                                        ?>
                                   ...
                                   <div class="col-lg-6 col-md-6">
                                        <label>Level</label>
                                        <?php if($customer_reference_no ==''){
                                        echo '<input id="level"  type="text" placeholder="Level" value="None"  readonly>';
                                        }else{
                                            echo '<input id="level"  type="text" placeholder="Level"  value="Level '.$level.'" readonly>';
                                        }
                                        ?>
                            ...
                            <button id="edit_customer" class="button" >Save Changes</button>
            ...
            <input id="custid" type="hidden" value="<?php echo $id ;?>"  disabled>
